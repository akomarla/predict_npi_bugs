...
### this is the column of the completed program you want to use as your prediction model
### data is in the "all sightings static" file

Program_Location = 15
Hist_Program_Data = Data.iloc[:,Program_Location][~Data.iloc[:,Program_Location].isna()].reset_index(drop = True)

## Approximate measure of program size (in terms of final max. cum. sightings)
## uncomment the size that's closest to the program selected above
...
fig_exp_fitted.savefig('C:/Users/{}/Documents/Sightings_Curve_Fitting/fig_historical_exp_fitted_plot.jpg'.format(Username))
fig_exp_extended.savefig('C:/Users/{}/Documents/Sightings_Curve_Fitting/fig_historical_exp_extended_plot.jpg'.format(Username))
...
with pd.ExcelWriter('C:/Users/{}/Documents/Sightings_Curve_Fitting/Historical_Analysis/Historical_Prediction_Data_{}.xlsx'.format(Username, Hist_Program_Data.name)) as writer:
    ...
    pd.DataFrame([Least_Residual_Prediction['Name'], Least_Residual_Prediction['WW Beginning LP'], Least_Residual_Prediction['Linear Phase Length'], Least_Residual_Prediction['Inflection Point WW'], Least_Residual_Prediction['Residual']],\
                 index = ['Name', 'WW Beginning LP', 'Linear Phase Length', 'Inflection Point WW', 'Residual'], columns = ['Details']).to_excel(writer, sheet_name = 'Details')
...
plt.grid(linestyle = ':')
fig_predictions.savefig('C:/Users/{}/Documents/Sightings_Curve_Fitting/Historical_Analysis/historical_sightings_predictions_plot.jpg'.format(Username))
