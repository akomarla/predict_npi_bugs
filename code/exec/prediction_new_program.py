...
# Data - Path of sightings data (check formatting) for new program (in progress)
# Program Size - Uncomment the size of the new program 
# Num_Points_Fit - Number of points to begin exponential fitting with (adjust if exponential fit fails)
...
Data = (pd.read_excel(open('C:/Users/{}/Desktop/python stuff/Sightings_Prediction_Analysis/all sightings static.xlsx'.format(Username), 'rb'), sheet_name = 'cum data groomed by PRQ - new'))
New_Program_Data = Data.iloc[:,1][~Data.iloc[:,1].isna()].reset_index(drop = True)
...
# Applying exponential fit on the curve 
...
# Adjust this value if exponential fit fails - start with higher than currnet number 
Num_Points_Fit = 50
...
fig_exp_fitted.savefig('C:/Users/{}/Desktop/python stuff/Sightings_Prediction_Analysis/New_Program_Predictions/new_program_exp_fit_plot_{}.jpg'.format(Username, New_Program_Data.name))
fig_exp_extended.savefig('C:/Users/{}/Desktop/python stuff/Sightings_Prediction_Analysis/New_Program_Predictions/new_program_exp_extend_plot_{}.jpg'.format(Username, New_Program_Data.name))
...
# Curve Inversion - Linear transformations & residual calculation
...
# Prediction list is a list of all the dictionaries
Predictions_List = [Prediction_M, Prediction_33_Up, Prediction_33_Dw, Prediction_16_Up, Prediction_16_Dw]

writer = pd.ExcelWriter('C:/Users/{}/Desktop/python stuff/Sightings_Prediction_Analysis/New_Program_Predictions/New_Program_Prediction_Data_{}.xlsx'.format(Username, New_Program_Data.name))
...
plt.grid(linestyle = ':')
fig_predictions.savefig('C:/Users/{}/Desktop/python stuff/Sightings_Prediction_Analysis/New_Program_Predictions/new_program_predictions_plot_{}.jpg'.format(Username, New_Program_Data.name))
