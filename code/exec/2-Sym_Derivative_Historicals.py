...
# Ignore this section if there is no interest in finding result for specific program
...
writer = pd.ExcelWriter('C:/Users/{}/Desktop/python stuff/Sightings_Prediction_Analysis/Historical_Analysis/Hist_Derv_Analysis_All_Programs.xlsx'.format(Username))
...
for j in range (0, Num_Programs_Completed ) :
    ...
    # Generating subplots of first and second derivative images for each program 
...
fig_sec_derv.savefig('C:/Users/{}/Desktop/python stuff/Sightings_Prediction_Analysis/Historical_Analysis/hist_second_derivative_plot_all_programs.jpg'.format(Username))
fig_fir_derv.savefig('C:/Users/{}/Desktop/python stuff/Sightings_Prediction_Analysis/Historical_Analysis/hist_first_derivative_plot_all_programs.jpg'.format(Username))   

with pd.ExcelWriter('C:/Users/{}/Desktop/python stuff/Sightings_Prediction_Analysis/Historical_Analysis/Hist_Linear_Phase_Data_All_Programs.xlsx'.format(Username)) as writer:
